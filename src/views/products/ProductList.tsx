                ...
                <div className="rounded-md bg-gray-50 border border-gray-200 px-3 py-3 text-sm space-y-2">
                  ...
                  {importResult.samples?.length > 0 && (
                    <div className="text-xs text-gray-600">
                      Muestras: {importResult.samples.join(', ')}
                    </div>
                  )}
                  {importResult.errors?.length > 0 && (
                    <div>
                      <div className="text-xs font-semibold text-red-700 mb-1">Errores:</div>
                  ...
                  {importResult.warnings?.length > 0 && (
                    <div>
                      <div className="text-xs font-semibold text-amber-700 mb-1">Advertencias:</div>

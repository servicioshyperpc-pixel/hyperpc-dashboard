...
export const ProductList: React.FC = () => {
  ...
  // Sin canales preseleccionados: igual que los campos, el usuario elige
  // explicitamente a donde actualizar. Antes venian los 5 marcados y una
  // actualizacion sin revisar el panel tocaba todos los marketplaces.
  const [bulkUpdateMarketplaces, setBulkUpdateMarketplaces] = useState<MarketplaceKey[]>([]);
